...
local function lsp_keymaps(bufnr)
  ...
  -- Alt+Enter - for code actions
	...
	-- vim.keymap.set('n', '<C-S-F>', "<cmd>lua vim.lsp.buf.format{async=true}<CR>", bufopts)
  -- vim.keymap.set('v', '<C-S-F>', "<cmd>lua vim.lsp.buf.format{async=true}<CR>", bufopts)
end
...
M.on_attach = function(client, bufnr)
  ...
  if client.name == "typescript-tools" then
    vim.keymap.set("n", "<leader>li", "<cmd>TSToolsOrganizeImports<cr>", { buffer = bufnr, desc = "Organize Imports" })
