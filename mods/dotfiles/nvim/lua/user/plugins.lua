...
local function define_plugins(use)
	...
	use({
		...
		commit = "a61c52d325835e24dc14ffb7748a32b8f087ae32",
	})
	...
	use({
		...
		commit = "2ef7da3a363890686dbaad18ddbf59177cfe4f78",
	})

	-- Treesitter
	use({
		"nvim-treesitter/nvim-treesitter",
		commit = "4b27f87fef2df2feaca47a8498f5f7f51e94b765",
	})
	...
	use({
		...
		commit = "9720eb5fa2f41988e8770f973cd11b76dd568a5d",
	})
	...
	use({
	  ...
	  -- '/Users/nick/code/nvim-dadbod-bg',
		config = function()
			vim.cmd([[
        let g:nvim_dadbod_bg_port = '4545'
