...
local mappings = {
  ...
  d = {
    ...
    L = { "<Cmd>lua require'dap'.set_breakpoint(vim.fn.input(nil, nil, vim.fn.input('Log point message: ')))<CR>",
      "log point" },
  ...
  f = {
    ...
    e = { "<cmd>lua require('user.telescope').search_buffers()<CR>",
      "Buffers"
    },
    r = { "<cmd>lua require('user.telescope').find_files_from_root()<CR>",
      "Files"
    },
    t = { "<cmd>lua require('user.telescope').search_git_files()<CR>", "Git Files" },
    p = { "<cmd>Telescope file_browser path=%:p:h<CR>",
      "Project"
    },

    -- b = { "<cmd>Telescope git_branches<cr>", "Checkout branch" },
    c = { "<cmd>Telescope git_status<cr>", "(c)hanged file" },
